...
export default function ClientOpsDashboard({ monthsAvailable, monthLabels, centresByMonth, retainers, mockUsedHours, nonMediaClients }) {
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        <div className="mt-6 flex items-start gap-2 text-xs text-[#8A8578] max-w-3xl">
          ...
          <p>
            ...
            Hours <em>used</em> are placeholder values standing in for the Teamwork API — these aren't month-specific yet. Annual retainer pacing assumes an April–March UK tax year, per your confirmation.
          </p>
        </div>
      </div>
    </div>
